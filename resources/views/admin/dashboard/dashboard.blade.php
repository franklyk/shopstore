    ...
    <div class="container-fluid">
        ...
        <div class="row g-4 mb-4">
            ...
            <div class="col-md-6 col-xl-4">
                <div class="card-vs card px-3 py-5 bg-transparent blur">
                    <dl class="row">
            ...
            <div class="col-md-6 col-xl-4">
                <div class="card-vs card px-3 py-5 bg-transparent">
                    <dl class="row">
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-6">
                <div class="card-vs card bg-transparent pb-3">
                    <div class="card-header">
                        <div class="card-title text-light   ">
                            ...
                            <tbody>
                                ...
                                @forelse($activeShipments as $shipment)
                                    <tr>
                                        ...
                                        <td data-field="center">Pedido nº {{ $shipment->order_id }}</td>
